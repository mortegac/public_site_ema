...
import { processCalendar } from "../resolvers/ProcessGoogleCalendar/resource";
import { releaseCalendarVisit } from "../resolvers/ReleaseCalendarVisit/resource";
import { blockInstallerSchedule } from "../resolvers/BlockInstallerSchedule/resource";
import { reserveCalendarVisit } from "../resolvers/ReserveCalendarVisit/resource";
import { generateTimeSlots } from "../crons/generateTimeSlots/resource";
import { makeReservationAndCart } from "../resolvers/MakeReservationAndCart/resource";
import { cleanUpCalendarVisits } from "../crons/cleanUpCalendarVisits/resource";
import { ReScheduleCalendarVisit } from "../resolvers/ReScheduleCalendarVisit/resource";
import { FetchCalendarForDate } from "../resolvers/FetchCalendarForDate/resource";
/**
...
export const MainSchema = a
  .schema({
    ...
    ShoppingCartDetail: a.model({
      ...
      calendarId: a.id(),
      CalendarVisit: a.belongsTo("CalendarVisit", "calendarId"),
  ...
  .authorization((allow) => [
    ...
    allow.resource(processCalendar),
    allow.resource(releaseCalendarVisit),
    allow.resource(blockInstallerSchedule),
    allow.resource(reserveCalendarVisit),
    allow.resource(generateTimeSlots),
    allow.resource(makeReservationAndCart),
    allow.resource(cleanUpCalendarVisits),
    allow.resource(ReScheduleCalendarVisit),
    allow.resource(FetchCalendarForDate),
  ]);
