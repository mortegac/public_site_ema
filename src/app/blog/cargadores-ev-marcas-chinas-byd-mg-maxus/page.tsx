...
const blogPostingSchema = {
  ...
  keywords: 'cargadores autos chinos Chile, cargador BYD MG Maxus, Wallbox CCS2 Chile, instalación cargador auto eléctrico chino, conector Tipo 2 BYD, MG4 cargador trifásico, Maxus Euniq 6 Wallbox',
...
export default function ArticlePage() {
  return (
    <>
      ...
      />
      <HpHeaderNew />
      <BlogBreadcrumb title="Cargadores para autos chinos: BYD, MG y Maxus en Chile" />
      <Box component="main">
        {/* Featured image */}
          ...
          <Container maxWidth="lg">
            ...
            <Box sx={{ position: 'relative', height: { xs: 220, md: 400 }, borderRadius: '8px 8px 0 0', overflow: 'hidden', boxShadow: '0 8px 32px rgba(0,0,0,0.22)' }}>
              ...
              <Image
                ...
                src="/images/post/17_1170x400.png"

                alt="Cargadores compatibles con BYD, MG y Maxus — marcas chinas en Chile"
        ...
        <Box sx={{ py: 3, px: { xs: 2, md: 0 }, textAlign: 'center' }}>
          <Typography sx={{ fontSize: '0.95rem', color: '#475569' }}>
            ¿Tienes un BYD, MG o Maxus y quieres instalar un cargador en casa?{' '}
