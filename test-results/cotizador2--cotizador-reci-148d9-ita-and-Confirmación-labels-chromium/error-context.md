...
- Name: cotizador2.spec.ts >> /cotizador/recibo-pago — with valid paymentData >> stepper shows Agendar visita and Confirmación labels
- Location: e2e/cotizador2.spec.ts:777:7
...
Locator: getByText('Agendar visita', { exact: true }).first()
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByText('Agendar visita', { exact: true }).first()
