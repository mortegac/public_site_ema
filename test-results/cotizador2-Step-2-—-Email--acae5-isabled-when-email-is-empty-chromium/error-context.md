...
- Name: cotizador2.spec.ts >> Step 2 — Email required to enable Webpay button >> Webpay button is disabled when email is empty
- Location: e2e/cotizador2.spec.ts:661:7
