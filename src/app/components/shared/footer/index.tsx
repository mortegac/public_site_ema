...
<Box
                    sx={{
                      width: { xs: '100%', sm: '90%', md: '90%', lg: '899px' },
                      maxWidth: '899px',
                      aspectRatio: '899 / 477',
                      position: 'relative',
                      marginTop: { xs: '50px', sm: '50px', md: '0px', lg: '0px' },
                      marginLeft: { xs: '150px', sm: '150px', md: '0px', lg: '0px' },
                    }}
                  >
                    <Image
                      src="/images/backgrounds/bg-city.svg"
                      alt="city background"
                      width={899}
                      height={477}
                      style={{
      ...
      >
        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: 'repeat(3, 1fr)', lg: 'repeat(4, 1fr)' }, gap: 3, mb: 7 }}>
           ...
           <Box sx={{ gridColumn: { xs: 'span 1', sm: 'span 1', lg: 'span 1' }, width: { xs: '100%', sm: 'auto' } }}>
            <Typography fontSize="17px" fontWeight="600" mb="22px" textAlign={"left"} sx={{ color: "#ffffff",}}>
              Redes sociales
            </Typography>
            ...
            <Typography fontSize="17px" fontWeight="600" mb="10px" mt="26px" textAlign={"left"}  sx={{ color: "#ffffff",}}>
            ¡Hablemos!
            </Typography>
