...
- Name: cotizador2.spec.ts >> Step 2 — Payment panel RM coverage validation >> RM address — shows depto, email fields and Webpay button normally
- Location: e2e/cotizador2.spec.ts:573:7
