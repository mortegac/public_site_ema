...
const HomePage = () => {
  return (
    <PageContainer title="Política de Privacidad | Energica City" description="Conoce cómo Energica City recopila, trata y protege tus datos personales de acuerdo con la Ley N° 19.628 de protección de la vida privada en Chile.">
