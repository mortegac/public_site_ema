...
export default function ArticlePage() {
  return (
    <>
      ...
      />
      <HpHeaderNew />
      <BlogBreadcrumb title="Tesla Wall Connector Gen 3: Instalación paso a paso en Chile" />
      <Box component="main">
        {/* Featured image */}
          ...
          <Container maxWidth="lg">
            ...
            <Box sx={{ position: 'relative', height: { xs: 220, md: 400 }, borderRadius: '8px 8px 0 0', overflow: 'hidden', boxShadow: '0 8px 32px rgba(0,0,0,0.22)' }}>
              ...
              <Image
                ...
                src="/images/post/07_1170x400.png"

                alt="Instalación paso a paso del Tesla Wall Connector Gen 3 en Chile"
