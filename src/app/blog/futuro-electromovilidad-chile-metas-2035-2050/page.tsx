...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${CANONICAL_DOMAIN}/images/post/21_1170x400.png`,
        width: 1170,
        height: 400,
        alt: 'Futuro electromovilidad Chile metas 2035 carbono neutralidad',
      },
    ],
  },
  twitter: {
    ...
    images: [`${CANONICAL_DOMAIN}/images/post/21_1170x400.png`],
  },
}
...
export default function ArticlePage() {
  return (
    <>
      ...
      />
      <HpHeaderNew />
      <BlogBreadcrumb title="Chile 2035: El fin de los autos a gasolina y cómo prepararse" />
      <Box component="main">
        {/* Featured image */}
          ...
          <Container maxWidth="lg">
            ...
            <Box sx={{ position: 'relative', height: { xs: 220, md: 400 }, borderRadius: '8px 8px 0 0', overflow: 'hidden', boxShadow: '0 8px 32px rgba(0,0,0,0.22)' }}>
              ...
              <Image
                ...
                src="/images/post/21_1170x400.png"

                alt="Futuro de la electromovilidad en Chile — metas 2035 y 2050"
