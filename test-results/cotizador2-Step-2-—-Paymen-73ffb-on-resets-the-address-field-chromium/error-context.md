...
- Name: cotizador2.spec.ts >> Step 2 — Payment panel RM coverage validation >> non-RM address — "Cambiar dirección" button resets the address field
- Location: e2e/cotizador2.spec.ts:617:7
