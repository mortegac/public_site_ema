...
- Name: cotizador2.spec.ts >> /cotizador/recibo-pago — with valid paymentData >> shows email from paymentData in confirmation banner
- Location: e2e/cotizador2.spec.ts:763:7
...
Locator: getByText(/test@example.com/).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/test@example.com/).first()
