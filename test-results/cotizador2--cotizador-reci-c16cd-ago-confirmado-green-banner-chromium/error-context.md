...
- Name: cotizador2.spec.ts >> /cotizador/recibo-pago — with valid paymentData >> shows "Pago confirmado" green banner
- Location: e2e/cotizador2.spec.ts:758:7
...
Locator: getByText(/Pago confirmado/).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/Pago confirmado/).first()
