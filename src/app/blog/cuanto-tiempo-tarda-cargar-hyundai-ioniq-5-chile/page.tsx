...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${CANONICAL_DOMAIN}/images/post/14_1170x400.png`,
        width: 1170,
        height: 400,
        alt: 'Hyundai Ioniq 5 6 tiempos carga cargadores Chile',
      },
    ],
  },
  twitter: {
    ...
    images: [`${CANONICAL_DOMAIN}/images/post/14_1170x400.png`],
  },
}
          ...
          <Container maxWidth="lg">
            ...
            <Box sx={{ position: 'relative', height: { xs: 220, md: 400 }, borderRadius: '8px 8px 0 0', overflow: 'hidden', boxShadow: '0 8px 32px rgba(0,0,0,0.22)' }}>
              ...
              <Image
                ...
                src="/images/post/14_1170x400.png"

                alt="Carga del Hyundai Ioniq 5 con Wallbox — tiempos y opciones en Chile"
