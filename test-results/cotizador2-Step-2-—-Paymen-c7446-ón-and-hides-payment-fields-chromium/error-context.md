...
- Name: cotizador2.spec.ts >> Step 2 — Payment panel RM coverage validation >> non-RM address — shows "Sin cobertura en tu región" and hides payment fields
- Location: e2e/cotizador2.spec.ts:592:7
