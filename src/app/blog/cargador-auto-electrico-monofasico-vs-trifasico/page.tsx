...
export default function ArticlePage() {
  return (
    <>
      ...
      <HpHeaderNew />
      <BlogBreadcrumb title="Cargador Monofásico vs. Trifásico: ¿Cuál necesita tu auto?" />
          ...
          <Container maxWidth="lg">
            ...
            <Box sx={{ position: 'relative', height: { xs: 220, md: 400 }, borderRadius: '8px 8px 0 0', overflow: 'hidden', boxShadow: '0 8px 32px rgba(0,0,0,0.22)' }}>
              ...
              <Image
                ...
                src="/images/post/12_1170x400.png"

                alt="Comparación entre cargador monofásico 7kW y trifásico 22kW para EV"
