...
- Name: cotizador2.spec.ts >> Step 2 — Próxima visita disponible >> nextAvailableDate also populates the step inside the cronograma
- Location: e2e/cotizador2.spec.ts:466:7
