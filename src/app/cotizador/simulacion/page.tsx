...
export default function FormResumeVirtual() {
  ...
  async function sendEmailResume(data:any){
    ...
    sendEMail && setSendEMailBox({
      msg:`Email enviado a ${data?.email}`,
      hasSent:true
    })
    
    !sendEMail && setSendEMailBox({
      msg:`Se produjo un error al enviar el Email a ${paymentDataLocal?.email}`,
      hasSent:false
    })
              ...
              >
                ...
                {paymentDataLocal?.hasData === true ?
                  ...
                  >
                    ...
                    <br /><br />A continuación encontrarás el desglose detallado de los valores referenciales para tu instalación. Este presupuesto ha sido diseñado específicamente según los datos que ingresaste en nuestro formulario.
                      ...
                      <div className="mt-6 space-y-4">
                        ...
                        <p className="text-gray-700">
                          Se estima para una distancia de <b>{paymentDataLocal?.mts} </b> de cableado entre el tablero eléctrico y el estacionamiento.
                        </p>
                        <p className="text-gray-700">
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '50vh', flexDirection: 'column' }}>
                    ...
                    }}>No se encontraron datos de la simulación</Typography>
                    <Button
                          variant="contained"
                          size="large"
                          sx={{
