...
- Name: cotizador2.spec.ts >> Step 2 — Email required to enable Webpay button >> Webpay button is enabled after filling a valid email with RM address
- Location: e2e/cotizador2.spec.ts:674:7
