...
const AgendaClient = () => {
  ...
  return (
    <PageContainer title="Agenda tu Visita Técnica | Energica City" description="Agenda tu visita técnica para la instalación de tu cargador eléctrico. Elige el horario que mejor te acomode.">
