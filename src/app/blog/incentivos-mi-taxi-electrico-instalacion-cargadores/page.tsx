...
export default function ArticlePage() {
  return (
    <>
      ...
      />
      <HpHeaderNew />
      <BlogBreadcrumb title="Programa Mi Taxi Eléctrico: Carga domiciliaria para conductores" />
      <Box component="main">
        {/* Featured image */}
          ...
          <Container maxWidth="lg">
            ...
            <Box sx={{ position: 'relative', height: { xs: 220, md: 400 }, borderRadius: '8px 8px 0 0', overflow: 'hidden', boxShadow: '0 8px 32px rgba(0,0,0,0.22)' }}>
              ...
              <Image
                ...
                src="/images/post/11_1170x400.png"

                alt="Programa Mi Taxi Eléctrico — subsidio para cargadores domiciliarios"
