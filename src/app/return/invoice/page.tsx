  ...
  useEffect(() => {
    ...
    if (storedData) {
      try {
        ...
        if (data.glosa && data.total && data.order) {
          setInvoiceData(data);
          ...
          >
            ...
            >
              <Box sx={{ textAlign: 'center', mb: 4 }}>
                <SvgSuccess email={invoiceData.email} />
              </Box>
                  ...
                  <Table size="small" sx={{ mb: 3 }}>
                    <TableBody>
                      <TableRow>
                        ...
                        >
                          <Typography fontSize="1.5rem">{formatCurrency(Number(invoiceData.total))}</Typography>
                        </TableCell>
                      </TableRow>
                    </TableBody>
                  </Table>
                  ...
                  <Table size="small">
                    <TableBody>
                      <TableRow>
                        ...
                        >
                          <Typography fontWeight="bold">{invoiceData.order}</Typography>
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        ...
                        <TableCell sx={{ py: 1, px: 2 }}>{invoiceData.card}</TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell
                          sx={{
