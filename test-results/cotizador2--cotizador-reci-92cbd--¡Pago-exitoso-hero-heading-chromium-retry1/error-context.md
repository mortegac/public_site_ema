...
- Name: cotizador2.spec.ts >> /cotizador/recibo-pago — with valid paymentData >> shows "¡Pago exitoso!" hero heading
- Location: e2e/cotizador2.spec.ts:748:7
...
Locator: getByRole('heading', { name: /Pago exitoso/ })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /Pago exitoso/ })
