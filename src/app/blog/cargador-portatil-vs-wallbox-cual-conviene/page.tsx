...
export default function ArticlePage() {
  return (
    <>
      ...
      />
      <HpHeaderNew />
      <BlogBreadcrumb title="Cargador Portátil vs. Wallbox: ¿Cuál es mejor para tu casa?" />
      <Box component="main">
        {/* Featured image */}
          ...
          <Container maxWidth="lg">
            ...
            <Box sx={{ position: 'relative', height: { xs: 220, md: 400 }, borderRadius: '8px 8px 0 0', overflow: 'hidden', boxShadow: '0 8px 32px rgba(0,0,0,0.22)' }}>
              ...
              <Image
                ...
                src="/images/post/06_1170x400.png"

                alt="Comparación entre cargador portátil y Wallbox para auto eléctrico"
