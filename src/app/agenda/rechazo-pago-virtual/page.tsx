...
const RetryTransactionVirtual = () => {
  const theme = useTheme();
  const router = useRouter();
  const dispatch = useAppDispatch();

  const { trackEvent } = useAnalytics();
  trackEvent('rechazo_pago', 'AGENDA_EMA', 'pago rechazado desde webpay - visita virtual')
          ...
          <>
            ...
            <Box bgcolor="#f8fafc" width={"100%"} mt={10}
              ...
              {paymentData?.shoppingCartId && <Button
                ...
                onClick={() => {
                  getRetry();
                  trackEvent('reintentar_pago', 'AGENDA_EMA', 'reintentar pago visita virtual')
                }}
              >
            ...
            <Box bgcolor="#f8fafc" width={"100%"} mt={8}
              ...
              <Button
                ...
                onClick={() => trackEvent('crear_ticket_soporte', 'AGENDA_EMA', 'ir a soporte por pago rechazado visita virtual') }
              >
              ...
              <Button
                ...
                href="/cotizador"
                onClick={() => trackEvent('simular_costo_instalacion', 'AGENDA_EMA', 'ir al cotizador') }
              >
...
export default RetryTransactionVirtual;
