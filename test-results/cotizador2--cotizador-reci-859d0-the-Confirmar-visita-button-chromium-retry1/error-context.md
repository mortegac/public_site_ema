...
- Name: cotizador2.spec.ts >> /cotizador/recibo-pago — booking flow >> selecting an available date enables the Confirmar visita button
- Location: e2e/cotizador2.spec.ts:818:7
