...
- Name: cotizador2.spec.ts >> /cotizador/recibo-pago — with valid paymentData >> shows "Elige una fecha" date-picker section
- Location: e2e/cotizador2.spec.ts:753:7
...
Locator: getByText('Elige una fecha').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Elige una fecha').first()
