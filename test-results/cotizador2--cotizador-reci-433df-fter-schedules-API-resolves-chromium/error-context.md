...
- Name: cotizador2.spec.ts >> /cotizador/recibo-pago — booking flow >> shows available date slot after schedules API resolves
- Location: e2e/cotizador2.spec.ts:813:7
